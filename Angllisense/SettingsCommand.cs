//------------------------------------------------------------------------------
// <copyright file="SettingsCommand.cs" company="Company">
...
namespace Angllisense {
    ...
    internal sealed class SettingsCommand {
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("f13e88da-897b-475a-8cb1-49b541cd771f");
        ...
        private void MenuItemCallback(object sender, EventArgs e) {
            string message = string.Format(CultureInfo.CurrentCulture, "Angllisense Settings", this.GetType().FullName);
